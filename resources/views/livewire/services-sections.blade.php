        ...
        <div class="relative container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
                ...
                <div x-data="{ shown: false }"
                     ...
                     class="group relative bg-secondary-500/10 backdrop-blur-sm rounded-2xl p-8 transition-all duration-800 ease-out hover:bg-secondary-500/20 hover:scale-[1.02] hover:shadow-xl">
                    <!-- Decorative elements -->
                    ...
                    <!-- Hover effect line -->
                    <div class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-primary-500 to-primary-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 rounded-b-2xl"></div>
                </div>
                @endforeach
            </div>
        </div>
