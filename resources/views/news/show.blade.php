        ...
        <div class="container mx-auto px-4 py-12">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-7xl mx-auto">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="mt-12 pt-6 border-t border-gray-700 bg-tertiary-500">
                        ...
                        <div class="flex space-x-4">
                            <a href="https://api.whatsapp.com/send?text={{ urlencode($news->getTitle() . ' ' . request()->url()) }}"
                               target="_blank"
                               class="p-2 rounded-full bg-tertiary-400 hover:bg-primary-500 transition-colors">
                        ...
                        <div class="space-y-6">
                            ...
                            <a href="{{ route('site.news.show', $site->getRouteParams(['slug' => $related->slug])) }}"
                               class="group block">
                                ...
                                <h4 class="text-white text-lg font-medium group-hover:text-primary-500 transition-colors">
                                    {{ $related->getTitle() }}
                                </h4>
                    ...
                    <a href="{{ route('site.news.show', $site->getRouteParams(['slug' => $previousNews->slug])) }}"
                       class="group flex items-center">
                        ...
                        <div>
                            ...
                            <span class="block text-white group-hover:text-primary-500 font-medium">{{ $previousNews->getTitle() }}</span>
                        </div>
                    </a>
                    @endif
                    ...
                    <a href="{{ route('site.news.show', $site->getRouteParams(['slug' => $nextNews->slug])) }}"
                       class="group flex items-center justify-end md:justify-end">
                        <div class="text-right">
                            ...
                            <span class="block text-white group-hover:text-primary-500 font-medium">{{ $nextNews->getTitle() }}</span>
                        </div>
                        <svg class="w-6 h-6 text-gray-400 group-hover:text-primary-500 ml-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
